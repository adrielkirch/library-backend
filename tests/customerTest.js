...
const customerService = require("../src/services/service.customer");
...
describe("Customer Controllers", () => {
  describe("pagination", () => {
    it("should return a pagination customer", async () => {
      const req = {
        query: {
          page: 1,
          limit: 10,
      ...
      const signupStub = sinon.stub(customerService, "pagination").resolves(fakeCustomer);
      ...
      assert(res.json.calledOnceWith(fakeCustomer));
